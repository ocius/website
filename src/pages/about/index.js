              ...
              <Row className="primary-content centered">
                <Col xs={12} md={6} lg={3}>
                  ...
                  <div className="left-align">
                    <p>
                      Now a professional director, Mark has been a shareholder in OCIUS since 2000.
                      He has a degree in Engineering and an MBA and has been Managing Director of
                      two large mining companies and one of Australia’s leading industry
                      associations.
                    </p>
                    <p>
                      Mark represented Australia in sailing in the 1972 and 1976 Olympic Games and
                      has won World Championships in three international classes. Mark was made a
                      Member of the Order of Australia (AM) in early 2011 for services to industry
                      and to sailing.
                    </p>
                  </div>
                </Col>
                <Col xs={12} md={6} lg={3}>
                  ...
                  <div className="left-align">
                    <p>
                      ...
                      the first ‘solarsailor’ prototype which won the Advanced Technology Boat Race
                      in Canberra in 1997.
                    </p>
                    <p>
                      The first commercial &apos;solarsailor&apos; ferry won the Australian Design
                      Award of the Year in 2001. Robert is Intel Environment Laureate and a WWF
                      Future Maker recipient and was recently honoured to be a finalist for the
                      International Windship Awards Lifetime Achievement Award. In 2017, Robert was
                      awarded the Spitfire Memorial Defence Association Fellowship.
                    </p>
                  </div>
                </Col>
                <Col xs={12} md={6} lg={3}>
                  ...
                  <div className="left-align">
                    <p>
                      Well respected for his strategic thinking and passion for business
                      transformation programs, Geoff has earned the admiration and respect of many
                      C- level executives within leading Australian organisations in both government
                      and private sectors.
                    </p>
                    <p>
                      Part of the founding management team at Holocentric, a Canberra based, he
                      draws upon his extensive experience working in sales and in senior management
                      roles for global companies such as Honeywell, Microsoft and Cisco Systems to
                      help steer the company to success
                    </p>
                  </div>
                </Col>
                <Col xs={12} md={6} lg={3}>
                ...
                <Col xs={12} md={6} lg={4}>
                  ...
                  <div className="left-align">
                    <p>
                      ...
                      and overseas. The last 6 years has seen him primarily involved in autonomous
                      vehicle development and applications. Lloyd was a key member of Team Thunder,
                      who successfully competed in the 2014 UAV Challenge Outback Rescue competition
                      run by the CSIRO and Queensland University of Technology.
                    </p>
                    <p>
                      He has had considerable sailing experience having started sailing at an early
                      age on Lake Macquarie. In his current role as Senior Systems Engineer for
                      OCIUS Technology Ltd he feels he has found his dream job.
                    </p>
                  </div>
                </Col>
                <Col xs={12} md={6} lg={4}>
                  ...
                  <div className="left-align">
                    ...
                    <p>
                      ...
                      by the CSIRO and Queensland University of Technology.
                    </p>
                  </div>
                </Col>
                <Col xs={12} md={6} lg={4}>
                  ...
                  <div className="left-align">
                    <p>
                      Tracey has over 25 years’ experience in corporate and public practice
                      accounting, business advisory, tax and superannuation. 17 years of this
                      experience is in running her own CPA Public Practice Accounting Firm.
                    </p>
                    <p>
                      Specialising in Company Secretarial and outsourced Corporate Financial Officer
                      engagements, Business Taxation, Accounting, Advisory and Self-Managed
                      Superannuation Funds. The practice is a 100% sustainable business, adopts the
                      latest accounting and tax technology apps and 90% paperless.
                    </p>
                  </div>
                </Col>
              </Row>
              ...
              <Row className="primary-content">
                <Col xs={12} md={6} lg={6}>
                  ...
                  <p>
                    ...
                    develop a high-performance OCIUS Bluebottle Unmanned Surface Vessel (USV)
                    coupled with an integrated Thales Australia thin-line towed array sonar system.
                    This was demonstrated to NAVY on Aug 10, 2017, and exceeded all contract
                ...
                <Col xs={12} md={6} lg={6}>
                  ...
                  <p>
                    ...
                    industrial composite technology since 1947. Steber manufactures high-quality
                    boats for fishing, charter, patrol, sea rescue, medical support, surveillance
                    and general boating use. All Steber boats are individually designed and built to
                    suit their purpose, with a quality of manufacture that ensures a long service
                    life and the capability to put to sea when many other vessels need to return to
                    port. Steber&apos;s core business of composite component manufacture is all
                    undertaken in their climate controlled factory ensuring all laminating is
                    carried out within humidity and temperature parameters allowing 24-hour
                    production when required. Stebercraft is an Australian owned and operated family
            ...
            <Segmented borderBottom="">
              <Row className="primary-content">
                ...
                <Col xs={12} md={6} lg={6}>
                  ...
                  <p>
                    One2three naval architects designed our second prototype Bruce’s hull, keel,
                    deck and hatches. They are well known in the sailing world as the naval
                    architects who have multiple times re-designed “Wild Oats“ the record-breaking
                    maxi and 8 times winner of line honours in the Sydney to Hobart yacht race. They
                    will review Bruce’s seakeeping ability in a range of conditions to provide
                    several improvements in design, tracking, helm, payload bay & performance for
                    the next prototypes.
                  </p>
                </Col>
              </Row>
              ...
              <Row className="primary-content">
                <Col xs={12} md={6} lg={6}>
                  ...
                  <p>
                    ...
                    intelligent networks and machine learning with the University of New South
                    Wales. UNSW provide OCIUS with a Research & Development facility in UNSW’s
                ...
                <Col xs={12} md={6} lg={6}>
                  ...
                  <p>
                    ...
                    International boat race in 1997. They have provided equipment for all solar
                    sailor ferries, scale models and prototypes including our Bluebottles&apos;
                    steering mechanisms, patented rudder flipper appendages and patented solarsails
                    & mechanisms.
                  </p>
                </Col>
              </Row>
              ...
              <Row className="primary-content">
                <Col xs={12} md={6} lg={6}>
                  ...
                  <p>
                    ...
                    processing, electronic gaming, plastics, environmental, agricultural machinery
                    and more. He has been Solar Sailor’s and OCIUS&apos; patent attourney for over
                    15 years. Prior to founding Clark IP, David successfully managed the patent
                    practices at a major first tier law firm and has a strong business acumen so he
                    provides OCIUS with not only technically accurate work but also commercially
                    meaningful and relevant advice.
                  </p>
                  <p>
                ...
                <Col xs={12} md={6} lg={6}>
                  ...
                  <p>
                    During the Second World War Australian service men and women played a vital role
                    in every theatre of the conflict, leading to the successful Allied outcome in
                    1945. The Spitfire Association, founded by many of these men and women, remains
                    strong to this day. The spirit of camaraderie, service and enjoyment of life is
                    a hallmark of the Association, bound together by a love of this iconic aeroplane
                    the Spitfire.
                  </p>
                  <p>
                    ...
                    design and build of hardware for Bluebottle prototype Bruce. In 2017, Robert
                    Dane was honoured to be awarded the Spitfire Fellowship for the development of
                    the unique &apos;reel in the keel&apos; winch for Bluebottles, enabling a small
                    USV to carry any number of sensors in a seaworthy way and deploy and retrieve
                    that sensor to depths of 1 - 140m as desired.
                  </p>
                </Col>
              </Row>
            </Segmented>
            ...
            <Row className="primary-content">
              <Col xs={12} md={12} lg={12}>
                <p>
                  ...
                  unlisted company with Research and Development facilities at the University of
                  NSW.
                </p>

                <p>
                  In 1997, Solar Sailor won the Advanced Technology Boat Race in Canberra, beating
                  the next solar boat by 5 laps of 6km (30km) using a new patented &apos;solar
                  sail&apos; - a simple device which harnesses both solar and wind energy in a
                  seaworthy manner.
                </p>

                <p>
                  Since then, the company has proven a solid track record of conceiving, funding,
                  and delivering difficult, innovative, high-tech, award-winning projects on time
                  and on budget.
                </p>

                <p>
                  The company has built multiple &apos;solarsailor&apos; prototypes and six
                  ...
                  thousands of passengers. Today, four solarsailor hybrid electric ferries operated
                  by the Hong Kong Jockey Club operate 364 days of year, 14 hours a day, from Sai
                  Kung to Kau Sai Chau half the fuel ferries.
                </p>

                <p>
                  Following an enquiry from the USA in 2007 for a &apos;platform that could go to
                  sea forever&apos;, the company began research into the development of unmanned
                  solar/wind/wave powered ocean vessels or autonomous unmanned surface vessels.
                  Initially, a 20-foot manned engineering development model (EDM) proved the
                  &apos;speed of advance&apos; in all conditions, adequate power, payload and
                  persistence for a sustainable platform go to sea for months.
                </p>
                ...
                <p>
                  ...
                  building of the first 10&apos; prototype called &apos;Nemo&apos; (Latin for
                  &apos;no one&apos; ie unmanned) which provided significant proof of concept of a
                  solar, wind and wave powered USV carrying a significant payload.
                </p>

                <p>
                  Based on Nemo&apos;s development, in 2015, OCIUS was awarded a Capability
                  Technology Demonstrator (CTD) from Defence Science and Technology Group. This
                  proved a significant contract and OCIUS with our partner Thales developed an
                  18&apos; prototype &apos;Bruce&apos; for Antisubmarine Warfare (ASW), which was
                  demonstrated to the NAVY in August 2017.
                </p>
                ...
                <p>
                  In November 2019 &apos;Bruce&apos; participated Autonomous Warrior War games in
                  Jervis Bay. Due to extreme weather, &apos;Bruce&apos; was often the only USV
                  operating. Ocius&apos; intelligent C2 system was used to control another Navy WAMV
                  catamaran and 2 DSTG UUVs.
                </p>

                <p>
                  From May - June 2019, Ocius completed 6 week endurance and intelligent networking
                  trials in a designated AMSA approved &apos;box&apos; off the NSW Coast,
                  successfully completing the DIH contract 3 months ahead of schedule.
                </p>

                <p>
                  Ocius is continuing its work with Thales, testing a new Thales thin line array
                  deployed from the Bluebottle keel winch to significant and varying depths, which
                  is being demonstrated at Pacific 2019 Expo at Darling Harbour 8-10 October.
                </p>

                <strong>Commercial Ferries</strong>
                <p>
                  Solar Sailor built 6 commercial solar sailor vessels providing valuable experience
                  to OCIUS on the commercial maritime and technical applications of its technology
                  as well as developing an extensive network of first-class suppliers and partners.
                </p>
                <ul>
                  <li>
                    <strong>
                    ...
                    <strong>(Australia).&nbsp;</strong>This vessel was completed in one year and won
                    the Australian Design Award of the Year in 2001.
                  </li>
                  <li>
                    <strong>
                    ...
                    mainland at Sai Kung to the island of Kau Sai Chau where the HKJC has three 18
                    hole golf courses. The ferries alternate two routes of five and seven mile round
                    trips with slow sectors at each end in a 20-minute cycle. Solar Sailor modelling
                    predicted substantial savings in fuel consumption compared to the previous
                    ‘standard’ diesel ferry service, as well as reductions in emissions.&nbsp; The
                    boats in operation have exceeded this since in independent tests since delivery
                    and are still running 14 hours a day, seven days a week using half the fuel of
                    the previous ferries.
                  </li>
                  <li>
                    <strong>
                    ...
                    -metre high SolarSail with software integration, on a 250 pax VIP river cruise
                    boat vessel,&nbsp;&nbsp;‘
                    <em>
                ...
                <p>
                  ...
                  OCIUS began research into the development of unmanned solar/wind/wave and
                  ballasted powered ocean vessels or autonomous unmanned surface vessels. Initially,
                  a 20 foot&nbsp;manned engineering development model (EDM) proved the &apos;speed
                ...
                <p>
                  ...
                  Ulladulla Fibreglass and Engineering, OCIUS built multiple scale models for tank
                  and lake testing, culminating in the building of the first 10&apos; prototype
                  called &apos;Nemo&apos; (Latin for &apos;no one&apos; ie unmanned) which provided
                  significant proof of concept of a solar, wind and wave powered USV carrying a
                  significant payload.
                </p>
                <p>
                  Based on Nemo&apos;s development, in 2015 OCIUS was awarded a $3M Capability
                  Technology Demonstrator (CTD) from Defence Science and Technology Group. This
                  proved a significant contract and OCIUS with our partners developed an 18&apos;
                  prototype &apos;Bruce&apos; for Antisubmarine Warfare (ASW), which demonstrated to
                  NAVY in August 2017.
                </p>
              </Col>
            </Row>
              ...
              <Col xs={12} md={12} lg={12}>
                ...
                <Row>
                  <Col xs={12} md={6} lg={6}>
                    ...
                    <p>
                      <strong>2019 April</strong> - Successful Seatrials of next-gen 18-foot
                      Bluebottle USV off NSW coast
                    </p>
                    <p>
                    ...
                    <p>
                      <strong>2015 </strong>- Build and successful testing of Bluebottle 10’
                      prototype ‘Nemo’
                    </p>
                    <p>
                      <strong>2015</strong> –{' '}
                    ...
                    <p>
                      <strong>2014</strong>&nbsp;– Sold 100 PAX<em> ‘Sydney SolarSailor’</em> ferry
                      to private buyer
                    </p>
                    <p>
                    ...
                    <p>
                      <strong>2010</strong> –<strong>&nbsp;</strong>Winner China Seatrade Award –
                      Dalian
                    </p>
                    <p>
                    ...
                    <p>
                      <strong>2010</strong> –&nbsp;Delivery of second HK ferry –{' '}
                      <em>‘Solar Birdie’</em>
                    </p>
                    <p>
                  ...
                  <Col xs={12} md={6} lg={6}>
                    ...
                    <p>
                      <strong>2009&nbsp;</strong>–<strong>&nbsp;</strong>Contract Schneider Electric
                      for SS HMP190/25 supply and warranty for Hong Kong boats
                    </p>
                    <p>
                      <strong>2009&nbsp;</strong>–<strong>&nbsp;</strong>Italian Well Tech Design
                      Award
                    </p>
                    <p>
                      <strong>2007 </strong>–&nbsp;Paper Australian Journal of Mechanical Engineers
                      Vol 4 No 2. ISSN: 1448-4846
                    </p>
                    <p>
                    ...
                    <p>
                      <strong>2004</strong>&nbsp;–<strong>&nbsp;</strong>United Nations Awards
                      finalist - Green Ferries for Blue Highways
                    </p>
                    <p>
                      <strong>2003</strong>&nbsp;–<strong>&nbsp;</strong>Contract Captain Cook
                      Cruises to manage and operate the <em>‘Sydney SolarSailor’</em>
                    </p>
                    <p>
                      <strong>2002</strong>&nbsp;–<strong>&nbsp;</strong>Hon Bob Hawke Chairman of
                      the Company
                    </p>
                    <p>
                    ...
                    <p>
                      <strong>2001</strong>&nbsp;–<strong>&nbsp;</strong>Winner Australian Design
                      Award of the Year 2001
                    </p>
                    <p>
                    ...
                    <p>
                      <strong>1997</strong>&nbsp;–<strong>&nbsp;</strong>Winner Advanced Technology
                      Boat Race Canberra – <em>‘Marjorie K’</em> prototype.
                    </p>
                  </Col>
                </Row>
              </Col>
...
export const query = graphql`
  query getAboutPageData {
    ...
    AndrewAitken: file(relativePath: { eq: "pages/about/Andrew-Aitken.png" }) {
      ...imageSharpAvatar
    }
