      ...
      <Col xs={12} md={12} lg={12}>
        ...
        <Row>
          <Col xs={12} md={6} lg={6}>
            ...
            <p>
              <strong>2019 April</strong> - Successful Seatrials of next-gen 18-foot Bluebottle USV
              off NSW coast
            </p>
            <p>
              ...
              with control of two USVs, two UUVs, networking to UK MAPLE C2 system and operations in
              all conditions during three week wargames.
            </p>
            <p>
              ...
              to demonstrate a network of intelligent persistent unmanned surface vessels Australian
              Maritime Innovation Award: Defence SME - With a $10 000 grant
            </p>
            <p>
  ...
  return (
    <Layout>
      ...
      <PageHeader>
        ...
        <NavTabs>
          <NavTab to="about">People</NavTab>
          <NavTab to="about/partners">Our Partners</NavTab>
          <NavTab to="about/our-story">Our Story</NavTab>
          <NavTab to="about/awards">Awards</NavTab>
          <NavTab to="about/in-the-news">In The News</NavTab>
        </NavTabs>
      </PageHeader>
