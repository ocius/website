          ...
          <Row className="primary-content">
            <Col xs={12} md={4} lg={4}>
              ...
              <p>
                ...
                and further developing technologies that have moved from the early science stages
                into the engineering and development stages of the innovation process. It is an
                exciting initiative that will pull together research institutions, academia,
                industry and innovative technologies. The Defence Innovation Hub facilitates
                innovation activities from initial concept, through prototyping and integrated
                testing.
              </p>
    ...
    <Container className="page-content">
      <Row className="primary-content">
        <Col xs={12} md={6} lg={6}>
          ...
          <p>
            ...
            passengers. Today, four &apos;solarsailor&apos; hybrid electric ferries operated by the
            Hong Kong Jockey Club operate 364 days of year, 14 hours a day, from Sai Kung to Kau Sai
      ...
      <Row className="primary-content">
        ...
        <Col xs={12} md={6} lg={6}>
          ...
          <p>
            ...
            contract and OCIUS partnered with Thales to develop an 18’ prototype ‘Bruce’ for
            Antisubmarine Warfare (ASW), which was successfully demonstrated to the NAVY in August
            2017.
          </p>
          ...
          <p>
            ...
            extreme weather, ‘Bruce’ was often the only USV operating. Ocius’ intelligent C2 system
            was used to control another Navy WAMV catamaran and 2 DSTG UUVs.
          </p>

          <p>
            From May - June 2019, Ocius completed 6 week endurance and intelligent networking trials
            in a designated AMSA approved ‘box’ off the NSW Coast, successfully completing the DIH
            contract 3 months ahead of schedule.
          </p>

          <p>
            In 2020 Ocius was awarded a $5.5M contract to build 5 next generation Bluebottles doing
            3 different applications in 3 different areas of operations off WA and NT over the next
            2 years. Ocius is continuing its work with Thales, testing new Thales thin line arrays
            deployed from the Bluebottle keel winch to significant and varying depths. Ocius is also
            working with UNSW and the NSW Government Defence Innovation Network and Charles Darwin
            University on various areas of Research and Development.
          </p>
        </Col>
      </Row>
      <Row className="primary-content">
      ...
      <Row className="primary-content">
        <Col xs={12} md={6} lg={6}>
          ...
          <p>
            From 2000 -2012, Solar Sailor built 6 commercial solar sailor vessels providing valuable
          ...
          <p>
            <strong>“SolarSailor” (Australia).</strong> This vessel was completed in one year to be
            ready for the Sydney Olympics and won the Australian Design Award of the Year in 2001.
          </p>
          <p>
            ...
            four commuter ferries to operate a service to transport players, staff and supplies from
            the mainland at Sai Kung to the island of Kau Sai Chau where the HKJC has three 18 hole
            golf courses. The ferries alternate two routes of five and seven mile round trips with
            slow sectors at each end in a 20-minute cycle. Solar Sailor modelling predicted
            substantial savings in fuel consumption compared to the previous ‘standard’ diesel ferry
            service, as well as reductions in emissions. The boats in operation have exceeded this
          ...
          <p>
            <strong>Shanghai World Expo (China).</strong> After demonstration of the Sydney ferry to
            Suntech, a Wuxi-based solar panel company, in 2009 OCIUS was awarded a contract to
            design, build and install a 12 -metre high SolarSail with software integration, on a 250
            pax VIP river cruise boat vessel,&nbsp;‘
          ...
          <p>
            In 2014, Solar Sailor sold it’s commercial ferry the Sydney Solar Sailor and changed its
            name to OCIUS (Latin for ‘fleet’) to reflect an expansion of its patented technologies
            and a pivot in direction for the company from commercial hybrid ferries to uncrewed
            vessels.
          </p>
        </Col>
        <Col xs={12} md={6} lg={6}>
          <figure>
            ...
            <figcaption>
              <strong>Top:</strong> Solar Sailor Vessel that was awarded Australian Design Award of
              the Year in 2001.
              <br />
              <strong>Above:</strong> SolarSailor vessel that operates as a commercial ferry in Hong
              Kong.
            </figcaption>
          </figure>
        </Col>
          ...
          <Col xs={12} md={6} lg={6}>
            ...
            <div className="left-align">
              <p>
                ...
                Championships in three international classes. Mark was made a Member of the Order of
                Australia (AM) in early 2011 for services to industry and to sailing.
              </p>
              <p>
          ...
          <Col xs={12} md={6} lg={6}>
            ...
            <div className="left-align">
              <p>
                ...
                first &apos;solarsailor&apos; prototype which won the Advanced Technology Boat Race
                in Canberra in 1997.
              </p>
              <p>
                In 2001, the first commercial &apos;solarsailor&apos; ferry using the technology won
                the Australian Design Award of the Year. Robert is Intel Environment Laureate 2007,
                the WWF Future Maker 2012 and in 2017 Robert was awarded the Spitfire Memorial
                Defence Association Fellowship. He leads a great team of engineers.
              </p>
            </div>
            <SocialIconButton
              network="linkedIn"
          ...
          <Col xs={12} md={6} lg={6}>
            ...
            <div className="left-align">
              <p>
                ...
                implemented new equipment and technology from Europe and the USA. He has also worked
                in Asia in GPS related industries.
              </p>
              <p>
          ...
          <Col xs={12} md={6} lg={4}>
            ...
            <div className="left-align">
              ...
              <p>
                ...
                Lake Macquarie. In his current role as Chief Engineer for OCIUS Technology Ltd he
                feels he has found his dream job.
              </p>
            </div>
            <SocialIconButton
              network="linkedIn"
          ...
          <Col xs={12} md={6} lg={4}>
            ...
            <div className="left-align">
              ...
              <p>
                ...
                CSIRO and Queensland University of Technology. Peter’s current role is Ocius Lead
                Software Engineer Peter running a team of software engineers and research projects.
              </p>
            </div>
            <SocialIconButton
              network="linkedIn"
      ...
      <HeroBlock image={data.HeroBackground.childImageSharp.fluid} masked scrim="blue">
        ...
        <Row className="centered">
          ...
          <Col xs={12} md={4} lg={4} mdOffset={2}>
            ...
            <p>To develop innovative, autonomous solutions for persistent maritime surveillance.</p>
          </Col>
        </Row>
      </HeroBlock>
    )}
